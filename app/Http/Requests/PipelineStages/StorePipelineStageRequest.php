...
class StorePipelineStageRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'is_won' => $this->isWonRules(),
            'is_lost' => $this->isLostRules(),
            'meta' => $this->metaRules(),
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'position.integer' => 'The position must be a whole number.',
            'position.min' => 'The position may not be negative.',
            ...
            'is_won.boolean' => 'The won flag must be true or false.',
            'is_lost.boolean' => 'The lost flag must be true or false.',
        ];
    }
    ...
    /**
     * Get validation rules for the is_won field.
     *
     * @return array<mixed>
     */
    protected function isWonRules(): array
    {
        return [
            'nullable',
            'boolean',
    ...
    /**
     * Get validation rules for the is_lost field.
     *
     * @return array<mixed>
     */
    protected function isLostRules(): array
    {
        return [
            'nullable',
            'boolean',
