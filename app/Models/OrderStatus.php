...
class OrderStatus extends Model implements Auditable
{
    ...
    /**
     * Get the user who created this order status.
     *
    ...
    /**
     * Get the user who last updated this order status.
     *
     * @return BelongsTo<User, $this>
     */
    ...
    /**
     * Get the user who deleted this order status.
     *
     * @return BelongsTo<User, $this>
     */
    ...
    /**
     * Get the user who restored this order status.
     *
     * @return BelongsTo<User, $this>
     */
