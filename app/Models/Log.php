...
class Log extends Model
{
    ...
    public const ACTION_CREATE_INTERACTION = 324;

    public const ACTION_UPDATE_INTERACTION = 325;

    public const ACTION_DELETE_INTERACTION = 326;

    public const ACTION_FORCE_DELETE_INTERACTION = 327;
