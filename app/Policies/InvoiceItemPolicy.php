...
class InvoiceItemPolicy
{
    ...
    {
        return $this->authorisationService->canView($user, $invoiceItem);
    }
    ...
    {
        return $this->authorisationService->canUpdate($user, $invoiceItem);
    }
    ...
    {
        return $this->authorisationService->canDelete($user, $invoiceItem);
    }
    ...
    {
        return $this->authorisationService->canRestore($user, $invoiceItem);
    }
    ...
    {
        return $this->authorisationService->canForceDelete($user, $invoiceItem);
    }
