...
class RegistrationInterestPolicy
{
     ...
     */
    public function view(User $user, RegistrationInterest $interest): bool
    {
        return $this->authorisationService->isAdmin($user);
    }
     ...
     */
    public function delete(User $user, RegistrationInterest $interest): bool
    {
        return $this->authorisationService->isAdmin($user);
    }
     ...
     */
    public function restore(User $user, RegistrationInterest $interest): bool
    {
        return $this->authorisationService->isAdmin($user);
    }
     ...
     */
    public function forceDelete(User $user, RegistrationInterest $interest): bool
    {
        return $this->authorisationService->isAdmin($user);
    }
