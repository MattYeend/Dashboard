...
class CommentPolicy
{
    ...
    {
        return $this->authorisationService->canView($user, $comment);
    }
    ...
    {
        return $this->authorisationService->canRestore($user, $comment);
    }
    ...
    {
        return $this->authorisationService->canForceDelete($user, $comment);
    }
