...
class PolicyAuthorisationService
{
    ...
    public function canView(User $actor, Industry $target): bool
    {
        ...
        return $actor->can('view industries') && $this->activeChecker->isActive($target);
    }
    ...
    public function canUpdate(User $actor, Industry $target): bool
    {
        ...
        return $actor->can('edit industries') && $this->activeChecker->isActive($target);
    }
    ...
    public function canDelete(User $actor, Industry $target): bool
    {
        ...
        return $actor->can('delete industries') && $this->activeChecker->canBeModified($target);
    }
    ...
    public function canRestore(User $actor, Industry $target): bool
    {
        ...
        return $actor->can('restore industries') && $this->activeChecker->canBeRestoredOrForceDeleted($target);
    }
