...
class QueryService
{
    ...
    /**
     * Get paginated ticket statuses with filters.
     */
    ...
    protected function paginate(Builder $query, int $perPage): array
    {
        ...
        return [
            'ticketStatuses' => [
                'data' => array_map(
                    fn (TicketStatus $ticketStatus) => $this->formatterService->format($ticketStatus),
                    $paginator->items()
                ),
