...
class PolicyAuthorisationService
{
    ...
    {
        return $this->activeChecker->isActive($post);
    }
    ...
    {
        return $this->activeChecker->isTrashed($post);
    }
    ...
    {
        return $actor->can('view any posts');
    }
