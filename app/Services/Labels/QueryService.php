...
class QueryService
{
    ...
    protected function paginate(
        ...
        return [
            'labels' => [
                'data' => array_map(
                    fn (Label $label) => $this->formatterService->format($label),
                    $paginator->items()
                ),
    ...
    protected function getPermissions(User $user): array
    {
        return [
            'permissions_meta' => [
                'can_create' => $user->can('create', Label::class),
                'can_view_any' => $user->can('viewAny', Label::class),
                'can_export' => $user->can('export', Label::class),
            ],
        ];
    }
