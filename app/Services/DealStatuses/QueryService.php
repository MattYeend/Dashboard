...
class QueryService
{
    ...
    protected function paginate(
        ...
        return [
            'dealStatuses' => [
                'data' => array_map(
                    fn (DealStatus $dealStatus) => $this->formatterService->format($dealStatus),
                    $paginator->items()
                ),
    ...
    protected function getPermissions(User $user): array
    {
        return [
            'permissions_meta' => [
                'can_create' => $user->can('create', DealStatus::class),
                'can_view_any' => $user->can('viewAny', DealStatus::class),
                'can_export' => $user->can('export', DealStatus::class),
            ],
        ];
    }
