...
class CommentableTypeRegistryService
{
    /**
     * Allow-list of commentable types. Keys are short, UI-facing identifiers.
     * 'model' is the fully-qualified class name actually stored in the
     * comments.commentable_type column (no morph map aliasing is used).
     */
    ...
    /**
     * Short keys + labels for populating the "commentable type" <select>.
     *
    ...
    /**
     * Options for the "commentable owner" <select>, keyed by short type.
     *
