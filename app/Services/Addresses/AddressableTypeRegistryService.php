...
{
    /**
     * Allow-list of addressable types. Keys are short, UI-facing identifiers.
     * 'model' is the fully-qualified class name actually stored in the
     * addresses.addressable_type column (no morph map aliasing is used).
     */
    ...
    /**
     * Short keys + labels for populating the "address type" <select>.
     *
    ...
    /**
     * Options for the "address owner" <select>, keyed by short type.
     *
