...
class ManagementService
{
    ...
    public function bulkDelete(
        ...
        $addresses = Address::whereIn('id', $requestedIds)->get();
    ...
    /**
     * Export addresses matching the given filters as a CSV download.
     *
