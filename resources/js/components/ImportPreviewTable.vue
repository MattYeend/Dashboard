        ...
        <table class="w-full text-sm">
            <thead>
                <tr class="border-b border-gray-700 text-left text-xs text-gray-400">
                    ...
                    <th v-for="column in columns" :key="column" class="px-3 py-2 capitalize">
                        {{ column }}
                    </th>
            ...
            <tbody>
                <tr v-for="row in rows" :key="row.row" class="border-b border-gray-800 last:border-b-0">
                    ...
                    <td class="px-3 py-2">
                        ...
                        <Badge v-else variant="destructive" :title="row.reason ?? undefined">
                            {{ row.reason }}
                        </Badge>
                    </td>
                </tr>
