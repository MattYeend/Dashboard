...
const modules = [
    {
        ...
        route: 'users.index',
        label: 'People',
        detail: 'Team members, roles and access',
    },
    {
        code: '02',
        route: 'companies.index',
        label: 'Companies',
        detail: 'Organisations you work with',
    },
    {
        code: '03',
        route: 'contacts.index',
        label: 'Contacts',
        detail: 'Phone, address and email records',
    },
    {
        code: '04',
        route: 'tasks.index',
        label: 'Tasks',
        detail: 'Assigned work with due dates',
    },
    {
        code: '05',
        route: 'deals.index',
        label: 'Deals',
        detail: 'Pipeline stages and value',
    },
];
...
<template>
    ...
    <div class="min-h-screen p-6 text-[#1b1b18] lg:p-10 dark:text-[#EDEDEC]">
        <header
            class="mx-auto mb-10 flex w-full max-w-5xl items-center justify-between text-sm lg:mb-16"
        >
            <span
                class="font-['Space_Grotesk'] text-base font-semibold tracking-tight"
            >
                Dashboard
            </span>
        ...
        <main class="mx-auto flex w-full max-w-5xl flex-col gap-16">
            <!-- Hero -->
            <section
                class="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center"
            >
                <div>
                    <p
                        class="mb-4 font-mono text-xs tracking-widest text-[#706f6c] uppercase dark:text-[#A1A09A]"
                    >
                        Service-oriented CRM
                    </p>
                    <h1
                        class="font-['Space_Grotesk'] text-4xl leading-tight font-semibold tracking-tight lg:text-5xl"
                    >
                        Every record has a story.
                        <span
                            class="block text-emerald-600 dark:text-emerald-400"
                            >Every change has an author.</span
                        >
                    </h1>
                    <p
                        class="mt-5 max-w-md text-[15px] leading-relaxed text-[#706f6c] dark:text-[#A1A09A]"
                    >
                        People, companies, contacts, tasks and deals, tracked
                        with a full audit trail: who created it, who last
                        touched it, and who restored it if it was ever deleted.
                    </p>
                ...
                >
                    <div
                        class="flex shrink-0 items-center justify-between border-b border-[#19140035] px-4 py-2 dark:border-[#3E3E3A]"
                    >
                        <span
                            class="flex items-center gap-2 text-[#706f6c] dark:text-[#A1A09A]"
                        >
                            <svg
                                width="6"
                                height="6"
            ...
            <section>
                ...
                <ul
                    class="divide-y divide-[#19140035] border-y border-[#19140035] dark:divide-[#3E3E3A] dark:border-[#3E3E3A]"
                >
                    <li
                    ...
                    >
                        ...
                        <div class="flex-1">
                            <p
                                class="font-['Space_Grotesk'] text-base font-medium"
                            >
                                {{ module.label }}
                            </p>
                            <p
        ...
        <footer
            class="mx-auto mt-16 w-full max-w-5xl border-t border-[#19140035] pt-6 text-xs text-[#706f6c] dark:border-[#3E3E3A] dark:text-[#A1A09A]"
        >
