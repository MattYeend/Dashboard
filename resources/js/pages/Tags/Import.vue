...
import { preview as importPreview, commit as importCommit } from '@/routes/tags/import';

defineOptions({
    layout: { breadcrumbs: [{ title: 'Tags', href: tagsIndex().url }, { title: 'Import' }] },
});
...
<template>
    <div class="space-y-6 p-6">
        <h1 class="text-lg font-semibold text-gray-200">Import tags</h1>
