...
import { preview as importPreview, commit as importCommit } from '@/routes/companies/import';

defineOptions({
    layout: { breadcrumbs: [{ title: 'Companies', href: companiesIndex().url }, { title: 'Import' }] },
});
...
async function onConfirmCommit(): Promise<void> {
    ...
    if (result) {
        router.visit(companiesIndex().url, {
...
<template>
    <div class="space-y-6 p-6">
        <h1 class="text-lg font-semibold text-gray-200">Import companies</h1>
