    ...
    <div class="rounded-lg border p-4">
        ...
        <dl class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
                ...
                <dd class="text-sm">
                    {{ pipelineStatus.creator?.name ?? 'System' }}
                </dd>
            </div>
            <div>
                <dt class="text-xs text-gray-400">Created at</dt>
                <dd class="text-sm">
                    {{ formatDateTime(pipelineStatus.created_at) }}
                </dd>
            </div>
            ...
            <div>
                ...
                <dd class="text-sm">
                    {{ pipelineStatus.updater?.name ?? 'System' }}
                </dd>
            </div>
            <div>
                <dt class="text-xs text-gray-400">Last updated at</dt>
                <dd class="text-sm">
                    {{ formatDateTime(pipelineStatus.updated_at) }}
                </dd>
            </div>
            ...
            <template v-if="pipelineStatus.deleted_at">
                <div>
                    ...
                    <dd class="text-sm">
                        {{ pipelineStatus.deleter?.name ?? 'System' }}
                    </dd>
                </div>
                <div>
            ...
            <template v-if="pipelineStatus.restored_at">
                <div>
                    ...
                    <dd class="text-sm">
                        {{ pipelineStatus.restorer?.name ?? 'System' }}
                    </dd>
                </div>
                <div>
