...
import { preview as importPreview, commit as importCommit } from '@/routes/deals/import';

defineOptions({
    layout: { breadcrumbs: [{ title: 'Deals', href: dealsIndex().url }, { title: 'Import' }] },
});
...
<template>
    <div class="space-y-6 p-6">
        <h1 class="text-lg font-semibold text-gray-200">Import deals</h1>
