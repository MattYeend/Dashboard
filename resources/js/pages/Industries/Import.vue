...
import { preview as importPreview, commit as importCommit } from '@/routes/industries/import';

defineOptions({
    layout: { breadcrumbs: [{ title: 'Industries', href: industriesIndex().url }, { title: 'Import' }] },
});
...
async function onConfirmCommit(): Promise<void> {
    ...
    if (result) {
        router.visit(industriesIndex().url, {
...
<template>
    <div class="space-y-6 p-6">
        <h1 class="text-lg font-semibold text-gray-200">Import industries</h1>
