            ...
            <div>
                ...
                <dd class="flex items-center gap-2 text-sm">
                    <span
                        ...
                        :style="{
                            backgroundColor: ticketPriority.background_colour,
                        }"
                    />
                    {{ ticketPriority.background_colour }}
                </dd>
            </div>
            <div>
                ...
                <dd class="flex items-center gap-2 text-sm">
                    <span
                        class="inline-block h-4 w-4 rounded border"
                        :style="{ backgroundColor: ticketPriority.text_colour }"
                    />
                    {{ ticketPriority.text_colour }}
                </dd>
            </div>
            <div>
                ...
                <dd class="text-sm">
                    <span
                        ...
                        :style="{
                            backgroundColor: ticketPriority.background_colour,
                            color: ticketPriority.text_colour,
                        }"
                    >
