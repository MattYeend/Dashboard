...
import { preview as importPreview, commit as importCommit } from '@/routes/addresses/import';

defineOptions({
    layout: { breadcrumbs: [{ title: 'Addresses', href: addressesIndex().url }, { title: 'Import' }] },
});
...
async function onConfirmCommit(): Promise<void> {
    ...
    if (result) {
        router.visit(addressesIndex().url, {
...
<template>
    <div class="space-y-6 p-6">
        <h1 class="text-lg font-semibold text-gray-200">Import addresses</h1>
