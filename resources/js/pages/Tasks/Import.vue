...
import { preview as importPreview, commit as importCommit } from '@/routes/tasks/import';

defineOptions({
    layout: { breadcrumbs: [{ title: 'Tasks', href: tasksIndex().url }, { title: 'Import' }] },
});
...
<template>
    <div class="space-y-6 p-6">
        <h1 class="text-lg font-semibold text-gray-200">Import tasks</h1>
